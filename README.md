...
 [База данных (gardb)](#база-данных-gardb)  
...
 [Демонстрационное front-end приложение (garapp)](#демонстрационное-front-end-приложение-garapp)  
[Контакты](#контакты)  
[Лицензия](#лицензия)
...
2. Открыть файл .env и отредактировать [переменные окружения](#переменные-окружения) исходя из ваших реалий и потребностей. После внесения изменений не забудьте сохранить файл .env.
...
1. В [переменной окружения](#переменные-окружения) `DATA_HANDLE_MODE` установить значение `service`.
...
1. В [переменной окружения](#переменные-окружения) `DATA_HANDLE_MODE` установить значение `manual`.
