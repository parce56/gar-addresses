...
|AUTH_BASIC|Указывается необходимость включения Basic-авторизации для API-сервиса.|false|
...
**Авторизация запроса:** 
В конфигурации по умолчанию авторизация для API-запроса отсутствует. При необходимости возможно включение Basic-авторизации через [переменную окружения](#%EF%B8%8F-переменные-окружения) `AUTH_BASIC`.
