...
class Apartment extends Model {
    ...
    async upsert(data) {
        const query = `
            INSERT INTO "${this.schema}".apartments (
                id, objectid, objectguid, changeid, number, aparttype, 
        ...
        const values = [
            ...
            data.number, data.aparttype, data.opertypeid, data.previd, 
    ...
    async bulkUpsert(items) {
        ...
        validItems.forEach((item, index) => {
            ...
            values.push(
                ...
                item.aparttype !== undefined ? item.aparttype : null,
