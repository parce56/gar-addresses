...
class MunHierarchy extends Model {
    ...
    async upsert(data) {
        const query = `
            INSERT INTO "${this.schema}".munhierarchy (
                id, objectid, parentobjid, changeid, oktmo, previd, nextid, 
        ...
        const values = [
            ...
            data.oktmo, data.previd, data.nextid,
    ...
    async bulkUpsert(items) {
        ...
        validItems.forEach((item, index) => {
            ...
            values.push(
                ...
                item.oktmo !== undefined ? item.oktmo : null,
